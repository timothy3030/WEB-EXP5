...
function myfunction(a) {
    ...
    lengths.sort();
    document.getElementById("short").innerHTML = "Shortest : " +
    lengths[0];
    ...
    document.getElementById("type").innerHTML = "Underweight";
        ...
        document.getElementById("type").innerHTML = "Normal";  } else if (bmi >= 25 && bmi < 30) { document.getElementById("type").innerHTML = "Overweight"; } else if (bmi >= 30) { document.getElementById("type").innerHTML = "Overweight"; } else {
         ...
         let inputvalue = parseFloat(document.getElementById("inputvalue").value); if (v1 == "Rupee" && v2 == "USD") {
                ...
                "\n\n Total Cost = " +
`${TotalCost}`;
document.getElementById("bill").innerHTML = document .getElementById("bill")
.innerHTML.replace(/\n\r?/g, "<br />");
}
}